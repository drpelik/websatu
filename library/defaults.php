...
<div class="art-content-layout layout-item-0">
    ...
    <div class="art-layout-cell layout-item-1" style="width: 100%">
        <p>Copyright © 2016 | <a href="http://www.drazimuth.com/">Dr Azimuth&nbsp;</a>| All Rights Reserved.<br>
        <!--<p>Copyright © 2016 | Dr Azimuth | All Rights Reserved.<br></p>
                                                                                <!==<p class="love">Made with <i class="icon ion-heart"></i> by Brian Gardner</p>--></p>
    </div>
    </div>
</div>
